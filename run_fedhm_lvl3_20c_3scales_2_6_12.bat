...
set "PORT=50091"
set "EXPERIMENT=fedhm_lvl3_20c_p25_3s_b4_e3_r100_split2612"
...
"%PYTHON_EXE%" -u -W ignore run_gloo.py ^
  --port %PORT% ^
  --arch resnet18_1 ^
  --complex_arch master=resnet18_1,worker=resnet18_1:resnet18_2:resnet18_4,num_clients_per_model=2:6:12 ^
