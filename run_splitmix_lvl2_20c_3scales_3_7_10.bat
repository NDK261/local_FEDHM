...
set "PORT=50084"
set "EXPERIMENT=splitmix_lvl2_20c_p10_3s_b4_e1_r60_split3710"
...
"%PYTHON_EXE%" -u -W ignore run_gloo.py ^
  ...
  --complex_arch master=ensresnet18_3.15,worker=ensresnet18_3.15:ensresnet18_1.05:ensresnet18_0.7,num_clients_per_model=3:7:10 ^
