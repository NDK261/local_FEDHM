...
set "PORT=50083"
set "EXPERIMENT=heterofl_lvl2_20c_p10_3s_b4_e1_r60_split3710"
...
"%PYTHON_EXE%" -u -W ignore run_gloo.py ^
  --port %PORT% ^
  --arch resnet18_1 ^
  --complex_arch master=resnet18_1,worker=resnet18_1:resnet18_0.64:resnet18_0.5,num_clients_per_model=3:7:10 ^
